...
You are working at the OddPoverty Bank and you were hired as a data science intern in the loan department, 
You are given the following dataset to model, which will classify whether someone applying for a loan,
it's a simple one for an intern with two variables,
